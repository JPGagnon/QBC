...
See `doc/readme-qt.rst` for instructions on building Quebecoin-Qt, the
...
on an OS X 10.6 64-bit machine fails. Official release builds of Quebecoin-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `Quebecoin-Qt.app` is easy:
